...
func profiles() map[string]Manager {
	return map[string]Manager{
		"pacman":     {ID: "pacman", Label: "Arch/CachyOS/Manjaro", Family: Linux, Tools: []string{"pacman"}, Install: []string{"pacman", "-S", "--needed"}, Yes: []string{"--noconfirm"}, Update: []string{"pacman", "-Syu"}, Remove: []string{"pacman", "-R", "--nosave"}, Search: []string{"pacman", "-Ss"}, Info: []string{"pacman", "-Si"}, Local: map[string][]string{".pkg.tar.zst": {"pacman", "-U"}, ".pkg.tar.xz": {"pacman", "-U"}, ".pkg.tar.gz": {"pacman", "-U"}}, Prepare: []string{"base-devel", "git", "curl", "wget", "tar", "unzip", "cmake", "meson", "ninja", "rust", "go", "npm", "flatpak"}, Priority: 100, NeedsElev: true},
		"apt":        {ID: "apt", Label: "Debian/Ubuntu/Mint/Pop/Kali", Family: Linux, Tools: []string{"apt-get", "apt"}, Install: []string{"apt-get", "install"}, Yes: []string{"-y"}, Update: []string{"apt-get", "update"}, Remove: []string{"apt-get", "remove"}, Search: []string{"apt-cache", "search"}, Info: []string{"apt-cache", "show"}, Local: map[string][]string{".deb": {"apt", "install"}}, Prepare: []string{"build-essential", "git", "curl", "wget", "tar", "unzip", "cmake", "meson", "ninja-build", "cargo", "golang-go", "npm", "flatpak"}, Priority: 90, NeedsElev: true},
		"dnf":        {ID: "dnf", Label: "Fedora/Nobara/RHEL-like", Family: Linux, Tools: []string{"dnf5", "dnf"}, Install: []string{"dnf", "install"}, Yes: []string{"-y"}, Update: []string{"dnf", "upgrade"}, Remove: []string{"dnf", "remove"}, Search: []string{"dnf", "search"}, Info: []string{"dnf", "info"}, Local: map[string][]string{".rpm": {"dnf", "install"}}, Prepare: []string{"@development-tools", "git", "curl", "wget", "tar", "unzip", "cmake", "meson", "ninja-build", "rust", "cargo", "golang", "npm", "flatpak"}, Priority: 80, NeedsElev: true},
		"zypper":     {ID: "zypper", Label: "openSUSE", Family: Linux, Tools: []string{"zypper"}, Install: []string{"zypper", "install"}, Yes: []string{"--non-interactive"}, Update: []string{"zypper", "refresh"}, Remove: []string{"zypper", "remove"}, Search: []string{"zypper", "search"}, Info: []string{"zypper", "info"}, Local: map[string][]string{".rpm": {"zypper", "install"}}, Prepare: []string{"patterns-devel-base-devel_basis", "git", "curl", "wget", "tar", "unzip", "cmake", "meson", "ninja", "rust", "cargo", "go", "npm", "flatpak"}, Priority: 70, NeedsElev: true},
		"apk":        {ID: "apk", Label: "Alpine", Family: Linux, Tools: []string{"apk"}, Install: []string{"apk", "add", "--no-cache"}, Yes: nil, Update: []string{"apk", "update"}, Remove: []string{"apk", "del"}, Search: []string{"apk", "search"}, Info: []string{"apk", "info"}, Local: map[string][]string{".apk": {"apk", "add", "--allow-untrusted"}}, Prepare: []string{"build-base", "git", "curl", "wget", "tar", "unzip", "cmake", "meson", "ninja", "rust", "cargo", "go", "npm", "flatpak"}, Priority: 60, NeedsElev: true},
		"xbps":       {ID: "xbps", Label: "Void Linux", Family: Linux, Tools: []string{"xbps-install"}, Install: []string{"xbps-install", "-S"}, Yes: []string{"-y"}, Update: []string{"xbps-install", "-Syu"}, Remove: []string{"xbps-remove"}, Search: []string{"xbps-query", "-Rs"}, Info: []string{"xbps-query", "-R"}, Local: map[string][]string{}, Prepare: []string{"base-devel", "git", "curl", "wget", "tar", "unzip", "cmake", "meson", "ninja", "rust", "cargo", "go", "nodejs", "flatpak"}, Priority: 50, NeedsElev: true},
		"eopkg":      {ID: "eopkg", Label: "Solus", Family: Linux, Tools: []string{"eopkg"}, Install: []string{"eopkg", "install"}, Yes: []string{"-y"}, Update: []string{"eopkg", "ur"}, Remove: []string{"eopkg", "remove"}, Search: []string{"eopkg", "search"}, Info: []string{"eopkg", "info"}, Local: map[string][]string{}, Prepare: []string{"system.devel", "git", "curl", "wget", "tar", "unzip", "cmake", "meson", "ninja", "rust", "golang", "nodejs", "flatpak"}, Priority: 45, NeedsElev: true},
		"emerge":     {ID: "emerge", Label: "Gentoo", Family: Linux, Tools: []string{"emerge"}, Install: []string{"emerge", "--ask=n"}, Yes: nil, Update: []string{"emerge", "--sync"}, Remove: []string{"emerge", "--unmerge"}, Search: []string{"emerge", "--search"}, Info: []string{"emerge", "--info"}, Local: map[string][]string{}, Prepare: []string{"git", "curl", "wget", "tar", "unzip", "cmake", "meson", "ninja", "rust", "go", "npm"}, Priority: 40, NeedsElev: true},
		"nix":        {ID: "nix", Label: "Nix/NixOS", Family: Linux, Tools: []string{"nix"}, Install: []string{"nix", "profile", "install", "nixpkgs#"}, Yes: nil, Update: []string{"nix", "flake", "update"}, Remove: []string{"nix", "profile", "remove"}, Search: []string{"nix", "search", "nixpkgs"}, Info: []string{"nix", "profile", "list"}, Local: map[string][]string{}, Prepare: []string{"git", "curl", "wget"}, Priority: 35, NeedsElev: false},
		"packagekit": {ID: "packagekit", Label: "PackageKit fallback", Family: Linux, Tools: []string{"pkcon"}, Install: []string{"pkcon", "install"}, Yes: []string{"-y"}, Update: []string{"pkcon", "refresh"}, Remove: []string{"pkcon", "remove"}, Search: []string{"pkcon", "search", "name"}, Info: []string{"pkcon", "details"}, Local: map[string][]string{".deb": {"pkcon", "install-local"}, ".rpm": {"pkcon", "install-local"}}, Prepare: []string{"git", "curl", "wget", "tar", "unzip", "cmake"}, Priority: 10, NeedsElev: false},
		"brew":       {ID: "brew", Label: "Homebrew/Linuxbrew/macOS", Family: Darwin, Tools: []string{"brew"}, Install: []string{"brew", "install"}, Yes: nil, Update: []string{"brew", "update"}, Remove: []string{"brew", "uninstall"}, Search: []string{"brew", "search"}, Info: []string{"brew", "info"}, Local: map[string][]string{}, Prepare: []string{"git", "curl", "wget", "cmake", "rust", "go", "node"}, Priority: 100, NeedsElev: false},
		"port":       {ID: "port", Label: "MacPorts", Family: Darwin, Tools: []string{"port"}, Install: []string{"port", "install"}, Yes: nil, Update: []string{"port", "selfupdate"}, Remove: []string{"port", "uninstall"}, Search: []string{"port", "search"}, Info: []string{"port", "info"}, Local: map[string][]string{}, Prepare: []string{"git", "curl", "wget"}, Priority: 60, NeedsElev: true},
		"winget":     {ID: "winget", Label: "Windows Package Manager", Family: Windows, Tools: []string{"winget"}, Install: []string{"winget", "install"}, Yes: []string{"--silent", "--accept-package-agreements", "--accept-source-agreements"}, Update: []string{"winget", "upgrade"}, Remove: []string{"winget", "uninstall"}, Search: []string{"winget", "search"}, Info: []string{"winget", "show"}, Local: map[string][]string{}, Prepare: []string{"Git.Git", "Microsoft.PowerShell", "Python.Python.3.12", "OpenJS.NodeJS", "GoLang.Go", "Rustlang.Rustup"}, Priority: 100, NeedsElev: false},
		"scoop":      {ID: "scoop", Label: "Scoop", Family: Windows, Tools: []string{"scoop"}, Install: []string{"scoop", "install"}, Yes: nil, Update: []string{"scoop", "update"}, Remove: []string{"scoop", "uninstall"}, Search: []string{"scoop", "search"}, Info: []string{"scoop", "info"}, Local: map[string][]string{}, Prepare: []string{"git", "curl", "wget", "go", "rust", "nodejs"}, Priority: 80, NeedsElev: false},
		"choco":      {ID: "choco", Label: "Chocolatey", Family: Windows, Tools: []string{"choco"}, Install: []string{"choco", "install"}, Yes: []string{"-y"}, Update: []string{"choco", "upgrade", "all"}, Remove: []string{"choco", "uninstall"}, Search: []string{"choco", "search"}, Info: []string{"choco", "info"}, Local: map[string][]string{}, Prepare: []string{"git", "curl", "wget", "golang", "rust", "nodejs"}, Priority: 70, NeedsElev: true},
	}
}
