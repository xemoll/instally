...
var knownApps = map[string]KnownApp{
	...
	"ollama":         {Name: "Ollama", Linux: Task{Kind: "official-ollama", Items: []string{"ollama"}}, Windows: "Ollama.Ollama", Mac: "ollama", MacCask: true, GitHub: "ollama/ollama"},
	"opencode":       {Name: "OpenCode", Aliases: []string{"open-code", "opencode-ai"}, Linux: Task{Kind: "official-opencode", Items: []string{"opencode"}}, Windows: "opencode", Mac: "anomalyco/tap/opencode", MacCask: false, GitHub: "anomalyco/opencode"},
	"claude-code":    {Name: "Claude Code", Aliases: []string{"claude", "anthropic-claude-code"}, Linux: Task{Kind: "official-claude-code", Items: []string{"claude-code"}}, Windows: "Anthropic.ClaudeCode", Mac: "claude-code", MacCask: true},
	"ai-tools":       {Name: "AI Coding Tools Pack", Aliases: []string{"ai-pack", "coding-ai", "coding-tools"}, Linux: Task{Kind: "ai-tools", Items: []string{"ai-tools"}}, Windows: "", Mac: ""},
	"zed":            {Name: "Zed", Aliases: []string{"zed-editor"}, Linux: Task{Kind: "github", Items: []string{"zed-industries/zed"}}, Mac: "zed", MacCask: true, GitHub: "zed-industries/zed"},
	...
	"cursor":         {Name: "Cursor", Linux: Task{Kind: "pkg", Items: []string{"cursor"}}, Windows: "Anysphere.Cursor", Mac: "cursor", MacCask: true},
